...
char pass[] = "2341abcd";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
...
void setup(){
  ...
  Serial1.begin(115200); //INICIALIZA A SERIAL PARA O ESP8266
  WiFi.init(&Serial1); //INICIALIZA A COMUNICAÇÃO SERIAL COM O ESP8266
  WiFi.config(IPAddress(10,0,0,95)); //COLOQUE UMA FAIXA DE IP DISPONÍVEL DO SEU ROTEADOR
