...
public class EditarAgendamento extends javax.swing.JFrame {
    ...
    public EditarAgendamento(Agendamento agen) {
        ...
        for(int dia:agen.getDiaSemana()){
            int indice = dia-1;
            if(indice>=0 && indice<radioSemana.size()){
                radioSemana.get(indice).setSelected(true);
            }
        }
        LocalTime timeAtv=agen.gethAtv().toLocalTime();
        LocalTime timeDesat=agen.gethDesat().toLocalTime();
        jSpinnerHoraIn.setValue(timeAtv.getHour());
        jSpinnerMinutosIn.setValue(timeAtv.getMinute());
        jSpinnerHoraFim.setValue(timeDesat.getHour());
        jSpinnerMinutosFim.setValue(timeDesat.getMinute());
        
        
        for(String dis:agen.getDispositivos()){
            switch (dis) {
                case "AR":
        ...
        jTextFieldSalas.setText(Arrays.stream(agen.getSalas()).boxed().map(Object::toString).collect(Collectors.joining(", ")));
    }
    ...
    private void initComponents() {
        ...
        jLabelAdicionarAgendamento.setText("Editar Agendamento");
        ...
        jRadioButtonAR.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButtonAR.setText("Ar-Condicionado");

        jRadioButtonLZ.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButtonLZ.setText("Luzes");
        ...
        jRadioButtonDS.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButtonDS.setText("DataShow");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jRadioButtonLZ)
                        .addGap(18, 18, 18)
                        .addComponent(jRadioButtonDS)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        JRadioButton[] radioDispositivos = {jRadioButtonAR, jRadioButtonLZ, jRadioButtonDS};
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarAgendamento(null).setVisible(true);
            }
        });
    }
